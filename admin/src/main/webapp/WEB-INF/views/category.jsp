                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 200px;">
                                    ...
                                    <div class="input-group-btn">
                                        ...
                                        <button onclick="add()" class="btn btn-default" style="margin-left: 2px"><i class="fa fa-plus"></i></button>
                                        <button class="btn btn-default" style="margin-left: 2px"><i class="fa fa-refresh"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
