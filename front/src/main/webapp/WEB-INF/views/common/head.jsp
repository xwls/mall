...
<!-- Custom Fonts -->
<link rel="stylesheet" href="${path}/static/font-awesome/css/font-awesome.min.css" type="text/css">
<link rel="stylesheet" href="${path}/static/fonts/font-slider.css" type="text/css">
